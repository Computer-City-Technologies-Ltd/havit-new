<template>
    ...
    <div class="container px-5 py-24 mx-auto">
        ...
        <div class="flex flex-wrap -m-2">
            ...
            <div class="p-2 w-full">
            <button class="flex mx-auto text-white bg-[#da3a2a]  py-2 px-8 focus:outline-none hover:bg-black text-lg rounded">Button</button>
            </div>

            <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <p class="leading-normal my-5 dark:text-white">75-76, B.S. Bhaban, 3rd Floor <br> Laboratory Road Dhaka-1205, Bangladesh <br> Tel: +880 2 9612629-30.</p>
